...
def generate_dummy_employees() -> list[EmployementRecordDB]:
...
def find_employee(
    employee_id: int, records: list[EmployementRecordDB] | None = None
) -> EmployementRecordDB | None:
...
def filter_by_department(
    department: str, records: list[EmployementRecordDB] | None = None
) -> list[EmployementRecordDB]:
...
def export_records_json(
    records: list[EmployementRecordDB] | None = None, indent: int = 2
) -> str:
